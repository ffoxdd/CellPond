...
function loadCellPond() {
	...
	const scripts = [
		...
		readScript("libraries/event-bus.js"),
		readScript("source/colour.js"),
		readScript("libraries/camera.js"),
		readScript("libraries/ui/config.js"),
		readScript("source/layout.js"),
		readScript("libraries/ui/atom-registry.js"),
		readScript("libraries/ui/atom.js"),
		readScript("libraries/ui/rectangle.js"),
		readScript("libraries/ui/circle.js"),
		readScript("libraries/ui/triangle.js"),
		readScript("libraries/ui/slot.js"),
		readScript("libraries/ui/highlight.js"),
		readScript("source/hexagon-button-inner.js"),
		readScript("source/channel-selection-side.js"),
		readScript("source/picker-pad.js"),
		readScript("source/triangle-pad.js"),
		readScript("source/triangle-handle.js"),
		readScript("source/symmetry-pad.js"),
		readScript("source/symmetry-handle.js"),
		readScript("source/paddle-handle.js"),
		readScript("source/option-padding.js"),
		readScript("source/picker-channel.js"),
		readScript("source/tall-rectangle.js"),
		readScript("source/diamond-pin.js"),
		readScript("source/pin-hole.js"),
		readScript("source/triangle-pick-up.js"),
		readScript("source/triangle-pick-down.js"),
		readScript("source/symmetry-toggle-x.js"),
		readScript("source/symmetry-toggle-y.js"),
		readScript("source/symmetry-toggle-r.js"),
		readScript("source/hexagon-handle.js"),
		readScript("source/hexagon-button.js"),
		readScript("source/channel-selection-end.js"),
		readScript("source/diamond-choice.js"),
		readScript("source/picker-channel-option.js"),
		readScript("source/symmetry-circle.js"),
		readScript("source/paddle.js"),
		readScript("source/hexagon.js"),
		readScript("source/colourtode-triangle.js"),
		readScript("source/colourtode-square.js"),
		readScript("source/colourtode-tool.js"),
		readScript("libraries/gradient.js"),
		readScript("libraries/draw-queue.js"),
